...
# Insert cryptocurrency data with explicit column names
    ...
    INSERT INTO cryptocurrencies (
        id, symbol, name, description, hashing_algorithm, 
        ...
        %(id)s, %(symbol)s, %(name)s, %(description)s, %(hashing_algorithm)s,
...
with DAG(
    ...
    for coin in coins:
        ...
        create_tables >> extract_current >> extract_hist >> transform_crypto >> transform_market >> load_data
